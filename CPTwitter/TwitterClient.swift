...
let consumerKey = "eDZFxmmLWwemFqdVz0i11sjIN"
let consumerSecret = "0Z9sTym2iYjTKdMmStr39wIPsHcGyEBzsURiUvWgGBCeDKuZIP"
...
class TwitterClient: BDBOAuth1SessionManager {
    ...
    func login(success: @escaping () -> (), failure: @escaping (Error) -> ()){
        ...
        fetchRequestToken(withPath: "oauth/request_token", method: "GET", callbackURL: URL(string: "cptweety://ouauth"), scope: nil, success: { (requestToken: BDBOAuth1Credential?) in
    ...
    func apiGet(params: NSDictionary = [:], success: @escaping (NSDictionary) -> (), failure: @escaping (Error) -> ()) {
        let urlString = "1.1/account/verify_credentials.json"
        get(urlString, parameters: params, progress: nil, success: {
    ...
    func homeTimeline(params: NSDictionary = [:], success: @escaping ([Tweet]) -> (), failure: @escaping (Error) -> ()){
